...
namespace TrainWagons
{
    public class PassengerWagon : Wagon
    {
        ...
        {
            get => seats;
            set => seats = value >= 0 ? value : throw new ArgumentException("Количество спальных мест не может быть отрицательным");
        }

        public PassengerWagon() : base() { SleepingPlaces = 20; Seats = 30; }
        ...
        public override void Show() => Console.WriteLine($"Пассажирский вагон #{Number}, Максимальная скорость: {MinSpeed} км/ч, Спальных мест: {SleepingPlaces}, Сидячих мест: {Seats}");
        ...
        {
            Console.WriteLine($"Пассажирский вагон #{Number}, ID: {Id}, Минималная скорость: {MinSpeed}, Количество спальных мест: {SleepingPlaces}");
        }
        ...
        public override string ToString() => $"Пассажирский вагон #{Number}, Максимальная скорость: {MinSpeed} км/ч, Спальных мест: {SleepingPlaces}, Сидячих мест: {Seats}";
    }
}